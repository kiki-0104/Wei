...
public class showBMIActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bmi<18.5){
            rem="體重過輕";
           Toast.makeText(this, R.string.strtoolight, Toast.LENGTH_LONG).show();
            view1.setImageResource(R.drawable.bmi1);
        }else if(bmi>24){
            rem="體重過重";
          Toast.makeText(this, R.string.strheavy, Toast.LENGTH_LONG).show();
            view1.setImageResource(R.drawable.bmi3);
        }else{
            rem="正常體重";
          Toast.makeText(this, R.string.strnormal, Toast.LENGTH_LONG).show();
